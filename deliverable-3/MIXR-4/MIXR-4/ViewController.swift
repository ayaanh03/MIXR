...
//  MIXR-4
//
//  Created by Jeffrey Chiu on 10/28/20.
//
...
class ViewController: UIViewController, SPTSessionManagerDelegate, SPTAppRemoteDelegate, SPTAppRemotePlayerStateDelegate {
    ...
    private let SpotifyClientID = "eeec8f004dda4760bfa86ad23b5e3e6eeeec8f004dda4760bfa86ad23b5e3e6e"
    private let SpotifyRedirectURI = URL(string: "MIXR://returnAfterLogin")!
